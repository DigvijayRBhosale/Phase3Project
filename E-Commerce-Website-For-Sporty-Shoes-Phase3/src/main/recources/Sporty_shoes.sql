...
reportPrice int(20));
insert into purchase_report values(1,"Strickrer","digvijaybhosale98@gmail.com","18-10-2000",399);
...
insert into user values(1,"Digvijay","digvijaybhosale98@gmail.com",22,"Male","Kolhapur");
select * from user;
